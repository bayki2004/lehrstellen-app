...
INSERT INTO companies (id, auth_user_id, company_name, industry, canton, city, postal_code, website_url, description, company_size, culture_tags, culture_description, contact_person, contact_email, verified, premium) VALUES
...
('a1000000-0000-0000-0000-000000000001'::uuid, 'a0000000-0000-0000-0000-000000000001'::uuid,
 ...
 'Sarah Müller', 'lehrstellen@swisscom.com', true, true),
...
('a1000000-0000-0000-0000-000000000002'::uuid, 'a0000000-0000-0000-0000-000000000002'::uuid,
 ...
 'Thomas Weber', 'ausbildung@usz.ch', true, true),

('a1000000-0000-0000-0000-000000000003'::uuid, 'a0000000-0000-0000-0000-000000000003'::uuid,
 ...
 'Anna Schneider', 'berufsbildung@sbb.ch', true, true),

('a1000000-0000-0000-0000-000000000004'::uuid, 'a0000000-0000-0000-0000-000000000004'::uuid,
 ...
 'Peter Müller', 'info@baeckerei-mueller.ch', true, false),

('a1000000-0000-0000-0000-000000000005'::uuid, 'a0000000-0000-0000-0000-000000000005'::uuid,
 ...
 'Lisa Brunner', 'apprenticeships@roche.com', true, true),

('a1000000-0000-0000-0000-000000000006'::uuid, 'a0000000-0000-0000-0000-000000000006'::uuid,
 ...
 'Marco Keller', 'berufsbildung@migros.ch', true, true),

('a1000000-0000-0000-0000-000000000007'::uuid, 'a0000000-0000-0000-0000-000000000007'::uuid,
 ...
 'Beat Zimmermann', 'lehrstelle@holzweg.ch', true, false),

('a1000000-0000-0000-0000-000000000008'::uuid, 'a0000000-0000-0000-0000-000000000008'::uuid,
 ...
 'Sandra Fischer', 'informatik-lehrstellen@zuerich.ch', true, false)
