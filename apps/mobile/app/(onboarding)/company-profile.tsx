      ...
      >
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <View style={styles.pickerContainer}>
              <Text style={styles.pickerLabel}>Unternehmensgröße</Text>
              <ScrollView
                horizontal
                showsHorizontalScrollIndicator={false}
                style={styles.chipScroll}
            ...
            <View style={styles.mediaSection}>
              ...
              <TouchableOpacity style={styles.mediaPickerButton} onPress={handlePickVideo}>
                <Text style={styles.mediaPickerText}>
                  {videoFile ? 'Video ausgewählt' : 'Video aus Galerie wählen'}
                </Text>
              </TouchableOpacity>
              {videoFile && (
            ...
            <View style={styles.mediaSection}>
              ...
              <TouchableOpacity style={styles.mediaPickerButton} onPress={handlePickPhotos}>
                <Text style={styles.mediaPickerText}>
                  Fotos hinzufügen ({selectedPhotos.length}/10)
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.mediaSection}>
              ...
              <TouchableOpacity style={styles.mediaPickerButton} onPress={addLink}>
                <Text style={styles.mediaPickerText}>+ Link hinzufügen</Text>
              </TouchableOpacity>
            </View>
